...
var StyledHeader = (0, _styledComponents['default'])(_GridWrapper['default'])(
  _templateObject(),
);
exports.StyledHeader = StyledHeader;
var StyledBody = (0, _styledComponents['default'])(_GridWrapper['default'])(
  _templateObject2(),
);
exports.StyledBody = StyledBody;

var FakeScroller = _styledComponents['default'].div(
  _templateObject3(),
  function(props) {
